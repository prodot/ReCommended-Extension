...
{
    [Pure]
    static void DeriveExtensionArgumentAndExpectedArgumentCount(
        ...
        [NonNegativeValue] out int expectedArgumentCount)
    {
        ...
        {
            // extension invoked as an extension
        ...
        {
            // not an extension or extension not invoked as an extension
    ...
    [Pure]
    static TreeNodeCollection<ICSharpArgument?>? TryGetArgumentsForNoParameters(
        this ICSharpArgumentsOwner argumentsOwner,
    ...
    [Pure]
    static TreeNodeCollection<ICSharpArgument?>? TryGetArgumentsForUnnamedArguments(
        this ICSharpArgumentsOwner argumentsOwner,
        IParametersOwner parametersOwner,
        ICSharpArgument? extensionArgument,
    ...
    [Pure]
    static TreeNodeCollection<ICSharpArgument?>? TryGetArgumentForNamedArguments(
        this ICSharpArgumentsOwner argumentsOwner,
        IParametersOwner parametersOwner,
        ICSharpArgument? extensionArgument,
        [NonNegativeValue] int expectedArgumentCount)
    ...
    /// <c>null</c> items.<para/>
    /// For extension invocations, the qualifier is returned as the first argument. Note that the first argument is not a part of the syntax tree in
    /// this case and therefore cannot be used for highlighting.
    /// </remarks>
    [Pure]
    ...
    /// </remarks>
    [Pure]
    public static bool IsInvokedAsExtension(this ICSharpArgumentsOwner argumentsOwner)
    {
        if (argumentsOwner.Reference?.Resolve().DeclaredElement is IParametersOwner parametersOwner)
        {
