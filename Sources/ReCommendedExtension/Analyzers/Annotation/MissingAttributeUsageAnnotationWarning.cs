...
public sealed class MissingAttributeUsageAnnotationWarning(IAttributesOwnerDeclaration declaration, string message) : Highlighting(message) // todo: use MissingAnnotationWarning instead
{
