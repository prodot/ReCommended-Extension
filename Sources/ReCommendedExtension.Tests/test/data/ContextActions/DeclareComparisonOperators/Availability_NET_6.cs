...
namespace Test
{
    ...
    internal class Class{off}2 : IComparable<Class2>
    {
        public int CompareTo(Class2? other) => throw new NotImplementedException();
    }

    internal class Class2{off}WithOperators : IComparable<Class2WithOperators>
    {
    ...
    internal class Class2WithSome{off}Operators : IComparable<Class2WithSomeOperators>
    {
    ...
    {
        class Neste{off}d : IComparable<Nested>
        {
    ...
    internal struct Struct{off}2 : IComparable<Struct2>
    {
        public int CompareTo(Struct2 other) => throw new NotImplementedException();
    }

    internal struct Struct2With{off}Operators : IComparable<Struct2WithOperators>
    {
    ...
    internal struct Struct2WithSome{off}Operators : IComparable<Struct2WithSomeOperators>
    {
    ...
    internal record Class{off}Record : IComparable<ClassRecord>
    {
    ...
    internal record ClassRecordWith{off}Operators : IComparable<ClassRecordWithOperators>
    {
    ...
    internal record ClassRecordWithSome{off}Operators : IComparable<ClassRecordWithSomeOperators>
    {
    ...
    internal record struct Struct{off}Record : IComparable<StructRecord>
    {
        public int CompareTo(StructRecord other) => throw new NotImplementedException();
    }

    internal record StructRecordWit{off}hOperators : IComparable<StructRecordWithOperators>
    {
