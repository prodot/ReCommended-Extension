...
namespace Test
{
    ...
    internal class Cl{on}ass2 : IEquatable<Class2>
    {
        public bool Equals(Class2? other) => throw new NotImplementedException();
    }

    internal class Class2WithO{on}perators : IEquatable<Class2WithOperators>
    {
    ...
    internal struct Stru{on}ct2 : IEquatable<Struct2>
    {
        public bool Equals(Struct2 other) => throw new NotImplementedException();
    }

    internal struct Struct2WithOpe{on}rators : IEquatable<Struct2WithOperators>
    {
    ...
    internal record ClassReco{on}rd1;
    ...
    internal record ClassRec{on}ord2 : ClassRecord1;

    internal record ClassRec{on}ord3(int X) : ClassRecord1;

    internal record ClassRec{on}ord4(int X, int Y) : ClassRecord3(X);

    internal record struct StructRec{on}ord1;
