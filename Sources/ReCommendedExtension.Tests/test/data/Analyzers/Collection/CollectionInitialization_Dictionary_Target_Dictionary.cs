...
namespace TargetDictionary
{
    ...
    {
        Dictionary<int, string> field01 = new Dictionary<int, string>();
        ...
        Dictionary<int, string> field17 = new();
        ...
        {
            Dictionary<int, string> var01 = new Dictionary<int, string>();
            ...
            Dictionary<int, string> var17 = new();
            ...
            Consumer(new Dictionary<int, string>());
            ...
            ConsumerGeneric(new Dictionary<int, string>());
        ...
        Dictionary<int, string> Property01 { get; } = new Dictionary<int, string>();
        ...
        Dictionary<int, string> Property17 => new();
    ...
    {
        Dictionary<K, V> field01 = new Dictionary<K, V>();
        ...
        {
            Dictionary<K, V> var01 = new Dictionary<K, V>();
        ...
        Dictionary<K, V> Property01 { get; } = new Dictionary<K, V>();
