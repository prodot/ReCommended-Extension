...
namespace Test
{
    ...
    internal class Class2WithOperators : IEquatable<Class2WithOperators> // suggest to declare IEqualityOperators<Class2WithOperators, Class2WithOperators, bool> (implementation available)
    {
    ...
    internal struct Struct2WithOperators : IEquatable<Struct2WithOperators> // suggest to declare IEqualityOperators<Struct2WithOperators, Struct2WithOperators, bool> (implementation available)
    {
