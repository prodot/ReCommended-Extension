...
namespace Test
{
    public class Int16s
    {
        ...
        {
            var result11 = short.Clamp(number, 1, 1);
            var result12 = short.Clamp(number, short.MinValue, short.MaxValue);

            var result21 = Math.Clamp(number, (short)1, (short)1);
            var result22 = Math.Clamp(number, short.MinValue, short.MaxValue);
        }
