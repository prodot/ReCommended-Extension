...
namespace Test
{
    public class Int16s
    {
        ...
        {
            var result11 = short.TryParse(s, style, provider, out _);

            var result21 = short.TryParse(s1, style, provider, out _);

            var result31 = short.TryParse(utf8Text, style, provider, out _);
        }
    }
}