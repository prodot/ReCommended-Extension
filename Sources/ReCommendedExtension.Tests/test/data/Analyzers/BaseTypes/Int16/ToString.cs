...
namespace Test
{
    public class Int16s
    {
        public void RedundantArgument(short number, string format, IFormatProvider provider)
        {
        ...
        public void RedundantFormatPrecisionSpecifier(short number, IFormatProvider provider)
        {
