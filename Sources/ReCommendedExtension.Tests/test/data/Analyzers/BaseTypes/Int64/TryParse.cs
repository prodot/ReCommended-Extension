...
namespace Test
{
    public class Int64s
    {
        ...
        {
            var result11 = long.TryParse(s, style, provider, out _);

            var result21 = long.TryParse(s1, style, provider, out _);

            var result31 = long.TryParse(utf8Text, style, provider, out _);
        }
    }
}