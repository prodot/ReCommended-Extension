...
namespace Test
{
    public class Int32s
    {
        public void RedundantArgument(int number, string format, IFormatProvider provider)
        {
        ...
        public void RedundantFormatPrecisionSpecifier(int number, IFormatProvider provider)
        {
