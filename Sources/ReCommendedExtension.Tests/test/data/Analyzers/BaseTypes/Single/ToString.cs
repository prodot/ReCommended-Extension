...
namespace Test
{
    ...
    {
        public void RedundantArgument(float number, string format, IFormatProvider provider)
        {
        ...
        public void RedundantFormatPrecisionSpecifier(float number, IFormatProvider provider)
        {
