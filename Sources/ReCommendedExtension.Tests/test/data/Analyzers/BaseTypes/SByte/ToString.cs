...
namespace Test
{
    public class SBytes
    {
        public void RedundantArgument(sbyte number, string format, IFormatProvider provider)
        {
        ...
        public void RedundantFormatPrecisionSpecifier(sbyte number, IFormatProvider provider)
        {
