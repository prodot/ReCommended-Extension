...
namespace Test
{
    ...
    {
        public void RedundantArgument(uint number, string format, IFormatProvider provider)
        {
        ...
        public void RedundantFormatPrecisionSpecifier(uint number, IFormatProvider provider)
        {
