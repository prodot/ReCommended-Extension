...
namespace Test
{
    ...
    {
        public void RedundantArgument(ushort number, string format, IFormatProvider provider)
        {
        ...
        public void RedundantFormatPrecisionSpecifier(ushort number, IFormatProvider provider)
        {
