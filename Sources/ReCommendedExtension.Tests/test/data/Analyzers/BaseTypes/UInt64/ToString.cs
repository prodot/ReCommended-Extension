...
namespace Test
{
    ...
    {
        public void RedundantArgument(ulong number, string format, IFormatProvider provider)
        {
        ...
        public void RedundantFormatPrecisionSpecifier(ulong number, IFormatProvider provider)
        {
