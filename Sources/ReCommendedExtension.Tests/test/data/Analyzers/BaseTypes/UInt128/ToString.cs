...
namespace Test
{
    ...
    {
        public void RedundantArgument(UInt128 number, string format, IFormatProvider provider)
        {
        ...
        public void RedundantFormatPrecisionSpecifier(UInt128 number, IFormatProvider provider)
        {
