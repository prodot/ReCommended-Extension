...
namespace Test
{
    ...
    {
        public void RedundantArgument(double number, string format, IFormatProvider provider)
        {
        ...
        public void RedundantFormatPrecisionSpecifier(double number, IFormatProvider provider)
        {
