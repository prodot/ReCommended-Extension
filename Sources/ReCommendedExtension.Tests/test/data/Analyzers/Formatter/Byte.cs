...
namespace Test
{
    ...
    {
        public void RedundantFormatSpecifier(byte number)
        {
        ...
        public void RedundantFormatSpecifierProvider(byte number, string format, IFormatProvider provider)
        {
        ...
        public void RedundantFormatPrecisionSpecifier(byte number)
        {
        ...
        public void RedundantFormatPrecisionSpecifierProvider(byte number, IFormatProvider provider)
        {
        ...
        public void SuspiciousFormatSpecifier(byte number)
        {
        ...
        public void SuspiciousFormatSpecifier(byte number, IFormatProvider provider)
        {
        ...
        public void NoDetection(byte number, string format, IFormatProvider provider)
        {
