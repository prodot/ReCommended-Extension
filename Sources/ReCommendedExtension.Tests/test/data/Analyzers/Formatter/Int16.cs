...
namespace Test
{
    ...
    {
        public void RedundantFormatSpecifier(short number)
        {
            var result11 = $"{number:G}";
            var result12 = $"{number:G0}";
            var result13 = $"{number:G5}";
            var result14 = $"{number:G6}";
            var result15 = $"{number:g}";
            var result16 = $"{number:g0}";
            var result17 = $"{number:g5}";
            var result18 = $"{number:g6}";

            var result21 = string.Format("{0:G}", number);
            var result22 = string.Format("{0:G0}", number);
            var result23 = string.Format("{0:G5}", number);
            var result24 = string.Format("{0:G6}", number);
            var result25 = string.Format("{0:g}", number);
            var result26 = string.Format("{0:g0}", number);
            var result27 = string.Format("{0:g5}", number);
            var result28 = string.Format("{0:g6}", number);
        }
        ...
        public void RedundantFormatSpecifierProvider(short number, string format, IFormatProvider provider)
        {
        ...
        public void RedundantFormatPrecisionSpecifier(short number)
        {
        ...
        public void RedundantFormatPrecisionSpecifierProvider(short number, IFormatProvider provider)
        {
        ...
        public void SuspiciousFormatSpecifier(short number)
        {
        ...
        public void SuspiciousFormatSpecifier(short number, IFormatProvider provider)
        {
        ...
        public void NoDetection(short number)
        {
            ...
            var result21 = string.Format("{0:G4}", number);
        ...
        public void NoDetection(short number, string format, IFormatProvider provider)
        {
