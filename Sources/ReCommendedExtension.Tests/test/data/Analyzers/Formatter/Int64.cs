...
namespace Test
{
    ...
    {
        public void RedundantFormatSpecifier(long number)
        {
            var result11 = $"{number:G}";
            var result12 = $"{number:G0}";
            var result13 = $"{number:G19}";
            var result14 = $"{number:G20}";
            var result15 = $"{number:g}";
            var result16 = $"{number:g0}";
            var result17 = $"{number:g19}";
            var result18 = $"{number:g20}";

            var result21 = string.Format("{0:G}", number);
            var result22 = string.Format("{0:G0}", number);
            var result23 = string.Format("{0:G19}", number);
            var result24 = string.Format("{0:G20}", number);
            var result25 = string.Format("{0:g}", number);
            var result26 = string.Format("{0:g0}", number);
            var result27 = string.Format("{0:g19}", number);
            var result28 = string.Format("{0:g20}", number);
        }
        ...
        public void RedundantFormatSpecifierProvider(long number, string format, IFormatProvider provider)
        {
        ...
        public void RedundantFormatPrecisionSpecifier(long number)
        {
        ...
        public void RedundantFormatPrecisionSpecifierProvider(long number, IFormatProvider provider)
        {
        ...
        public void SuspiciousFormatSpecifier(long number)
        {
        ...
        public void SuspiciousFormatSpecifier(long number, IFormatProvider provider)
        {
        ...
        public void NoDetection(long number)
        {
            ...
            var result21 = string.Format("{0:G18}", number);
