...
namespace Test
{
    ...
    {
        public void RedundantFormatSpecifier(UInt128 number)
        {
            var result11 = $"{number:G}";
            var result12 = $"{number:G0}";
            var result13 = $"{number:G39}";
            var result14 = $"{number:G40}";
            var result15 = $"{number:g}";
            var result16 = $"{number:g0}";
            var result17 = $"{number:g39}";
            var result18 = $"{number:g40}";

            var result21 = string.Format("{0:G}", number);
            var result22 = string.Format("{0:G0}", number);
            var result23 = string.Format("{0:G39}", number);
            var result24 = string.Format("{0:G40}", number);
            var result25 = string.Format("{0:g}", number);
            var result26 = string.Format("{0:g0}", number);
            var result27 = string.Format("{0:g39}", number);
            var result28 = string.Format("{0:g40}", number);
        }
        ...
        public void RedundantFormatSpecifierProvider(UInt128 number, string format, IFormatProvider provider)
        {
        ...
        public void RedundantFormatPrecisionSpecifier(UInt128 number)
        {
        ...
        public void RedundantFormatPrecisionSpecifierProvider(UInt128 number, IFormatProvider provider)
        {
        ...
        public void SuspiciousFormatSpecifier(UInt128 number)
        {
        ...
        public void SuspiciousFormatSpecifier(UInt128 number, IFormatProvider provider)
        {
        ...
        public void NoDetection(UInt128 number)
        {
            var result11 = $"{number:G38}";
            ...
            var result21 = string.Format("{0:G38}", number);
        ...
        public void NoDetection(UInt128 number, string format, IFormatProvider provider)
        {
