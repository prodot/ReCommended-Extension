...
namespace Test
{
    ...
    {
        public void RedundantFormatSpecifier(ulong number)
        {
            var result11 = $"{number:G}";
            var result12 = $"{number:G0}";
            var result13 = $"{number:G20}";
            var result14 = $"{number:G21}";
            var result15 = $"{number:g}";
            var result16 = $"{number:g0}";
            var result17 = $"{number:g20}";
            var result18 = $"{number:g21}";

            var result21 = string.Format("{0:G}", number);
            var result22 = string.Format("{0:G0}", number);
            var result23 = string.Format("{0:G20}", number);
            var result24 = string.Format("{0:G21}", number);
            var result25 = string.Format("{0:g}", number);
            var result26 = string.Format("{0:g0}", number);
            var result27 = string.Format("{0:g20}", number);
            var result28 = string.Format("{0:g21}", number);
        }
        ...
        public void RedundantFormatSpecifierProvider(ulong number, string format, IFormatProvider provider)
        {
            ...
            var result23 = number.ToString("G20");
            var result24 = number.ToString("g");
            var result25 = number.ToString("g0");
            var result26 = number.ToString("g20");
            ...
            var result43 = number.ToString("G20", provider);
            var result44 = number.ToString("g", provider);
            var result45 = number.ToString("g0", provider);
            var result46 = number.ToString("g20", provider);
        }

        public void RedundantFormatPrecisionSpecifier(ulong number)
        {
        ...
        public void RedundantFormatPrecisionSpecifierProvider(ulong number, IFormatProvider provider)
        {
        ...
        public void SuspiciousFormatSpecifier(ulong number)
        {
        ...
        public void SuspiciousFormatSpecifier(ulong number, IFormatProvider provider)
        {
        ...
        public void NoDetection(ulong number)
        {
            ...
            var result21 = string.Format("{0:G19}", number);
        ...
        public void NoDetection(ulong number, string format, IFormatProvider provider)
        {
