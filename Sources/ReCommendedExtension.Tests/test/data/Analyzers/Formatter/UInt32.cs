...
namespace Test
{
    public class Formatters
    {
        ...
        public void RedundantFormatSpecifierProvider(uint number, string format, IFormatProvider provider)
        {
        ...
        public void RedundantFormatPrecisionSpecifierProvider(uint number, IFormatProvider provider)
        {
        ...
        public void SuspiciousFormatSpecifier(uint number, IFormatProvider provider)
        {
        ...
        public void NoDetection(uint number, string format, IFormatProvider provider)
        {
