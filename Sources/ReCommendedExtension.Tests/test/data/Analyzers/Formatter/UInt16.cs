...
namespace Test
{
    public class Formatters
    {
        ...
        public void RedundantFormatSpecifierProvider(ushort number, string format, IFormatProvider provider)
        {
        ...
        public void RedundantFormatPrecisionSpecifierProvider(ushort number, IFormatProvider provider)
        {
        ...
        public void SuspiciousFormatSpecifier(ushort number, IFormatProvider provider)
        {
        ...
        public void NoDetection(ushort number, string format, IFormatProvider provider)
        {
