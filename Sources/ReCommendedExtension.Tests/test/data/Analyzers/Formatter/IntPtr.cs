...
namespace Test
{
    public class Formatters
    {
        public void RedundantFormatSpecifier(nint number)
        {
            ...
            var result13 = $"{number:g}";
            var result14 = $"{number:g0}";

            var result21 = string.Format("{0:G}", number);
            var result22 = string.Format("{0:G0}", number);
            var result23 = string.Format("{0:g}", number);
            var result24 = string.Format("{0:g0}", number);
        }
        ...
        public void RedundantFormatSpecifierProvider(nint number, string format, IFormatProvider provider)
        {
        ...
        public void RedundantFormatPrecisionSpecifierProvider(nint number, IFormatProvider provider)
        {
