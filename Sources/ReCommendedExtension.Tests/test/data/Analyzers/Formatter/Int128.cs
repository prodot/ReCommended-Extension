...
namespace Test
{
    ...
    {
        public void RedundantFormatSpecifier(Int128 number)
        {
        ...
        public void RedundantFormatSpecifierProvider(Int128 number, string format, IFormatProvider provider)
        {
        ...
        public void RedundantFormatPrecisionSpecifier(Int128 number)
        {
        ...
        public void RedundantFormatPrecisionSpecifierProvider(Int128 number, IFormatProvider provider)
        {
        ...
        public void SuspiciousFormatSpecifier(Int128 number)
        {
